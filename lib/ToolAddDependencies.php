...
namespace dna\core\package_conf {
    ...
    class ToolAddDependencies
    {
        ...
        private function AddFilter()
        {
            ...
            switch ($in){
                case 'a': $data=  FS::IO_get("\t\t\tpackage_name (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_name=$data;} break;
                case 'b': $data=  FS::IO_get("\t\t\tpackage_version (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_version=$data;} break;
                case 'c': $data=  FS::IO_get("\t\t\tpackage_uid (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_uid=$data;} break;
                case 'd': $data=  FS::IO_get("\t\t\tpackage_author_group (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_author_group=$data;} break;
                case 'e': $data=  FS::IO_get("\t\t\tpackage_copyright (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_copyright=$data;} break;
                case 'f': $data=  FS::IO_get("\t\t\tpackage_licenseUrl (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_licenseUrl=$data;} break;
                case 'g': $data=  FS::IO_get("\t\t\tpackage_require_license_acceptance (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_require_license_acceptance=$data;} break;
                case 'h': $data=  FS::IO_get("\t\t\tpackage_websiteUrl (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_websiteUrl=$data;} break;
                case 'i': $data=  FS::IO_get("\t\t\tpackage_docUrl (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_docUrl=$data;} break;
                case 'l':
                    ...
                    switch ($insub){
                        case 'a': $data=  FS::IO_get("\t\t\t\tauthor_name (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_author->author_name=$data;} break;
                        case 'b': $data=  FS::IO_get("\t\t\t\tauthor_surname (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_author->author_surname=$data;} break;
                        case 'c': $data=  FS::IO_get("\t\t\t\tauthor_nic (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_author->author_nic=$data;} break;
                        case 'd': $data=  FS::IO_get("\t\t\t\tauthor_link (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_author->author_link=$data;} break;
                        case 'e': $data=  FS::IO_get("\t\t\t\tauthor_other (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_author->author_other=$data;} break;
                        default: break;
                    }

                    break;
                case 'm': $data=  FS::IO_get("\t\t\tpackage_release_note (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_release_note=$data;} break;
                case 'n': $data=  FS::IO_get("\t\t\tpackage_description (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_description=$data;} break;
                case 'o': $data=  FS::IO_get("\t\t\tpackage_iconUrl (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->package_iconUrl=$data;} break;
                case 'p': $data=  FS::IO_get("\t\t\tpackage_tag (empty for cancel)>", false); if (isset($data) or $data!="" ){$this->filters->addTag($data);} break;
                default:
                break;
            }
        }
